    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_image', models.ImageField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(location='/home/orxan/Desktop/New/ecommerce/media'), upload_to=product.models.upload_product_file_loc)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(storage=django.core.files.storage.FileSystemStorage(location='/home/orxan/Desktop/New/static_cdn/product_media'), upload_to=product.models.upload_product_file_loc)),
